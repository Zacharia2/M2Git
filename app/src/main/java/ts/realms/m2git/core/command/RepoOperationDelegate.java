...
import ts.realms.m2git.core.command.actions.AddAllAction;
import ts.realms.m2git.core.command.actions.AddRemoteAction;
import ts.realms.m2git.core.command.actions.CherryPickAction;
import ts.realms.m2git.core.command.actions.CommitAction;
import ts.realms.m2git.core.command.actions.ConfigAction;
import ts.realms.m2git.core.command.actions.DiffAction;
import ts.realms.m2git.core.command.actions.FetchAction;
import ts.realms.m2git.core.command.actions.MergeAction;
import ts.realms.m2git.core.command.actions.NewBranchAction;
import ts.realms.m2git.core.command.actions.NewDirAction;
import ts.realms.m2git.core.command.actions.NewFileAction;
import ts.realms.m2git.core.command.actions.PullAction;
import ts.realms.m2git.core.command.actions.PushAction;
import ts.realms.m2git.core.command.actions.RawConfigAction;
import ts.realms.m2git.core.command.actions.RebaseAction;
import ts.realms.m2git.core.command.actions.RemoveRemoteAction;
import ts.realms.m2git.core.command.actions.ResetAction;
import ts.realms.m2git.core.command.actions.SyncRepoAction;
import ts.realms.m2git.core.command.actions.UndoAction;
import ts.realms.m2git.core.command.tasks.local.AddToStageTask;
import ts.realms.m2git.core.command.tasks.local.CheckoutFileTask;
import ts.realms.m2git.core.command.tasks.local.CheckoutTask;
import ts.realms.m2git.core.command.tasks.local.DeleteFileFromRepoTask;
import ts.realms.m2git.core.command.tasks.local.MergeTask;
